      ...
      <div className="max-w-md w-full bg-gray-800 border border-gray-700 rounded-lg shadow-xl p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gray-700 hover:bg-gray-600 disabled:bg-gray-800 text-gray-100 font-semibold py-2 px-4 rounded-md transition duration-200 border border-gray-600 cursor-pointer"
          >
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-400">
            ...
            <Link href="/signup" className="text-gray-300 hover:text-gray-200 font-medium">
              Sign up
            </Link>
          </p>
        </div>
